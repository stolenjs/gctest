        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("GoodCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  ...
                  "  GOODcoind [options] help                " + _("List commands") + "\n" +
                  "  GOODcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: GOODcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: GOODcoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 7558 or testnet: 7557)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 7556 or testnet: 7555)") + "\n" +
